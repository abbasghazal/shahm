...
class Config(object):
    ...
    # Get this value by running python3 stringsetup.py or https://repl.it/@shahm2n/stringsession
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/shahm-Arabic/shahmAr"
    )
    ...
    abbas_A = int(os.environ.get("abbas_A") or -1001526282589)
    ...
    OLDREP_REPO = os.environ.get("OLDREP_REPO", "https://github.com/shahmArabic/shahmAr")
    if OLDREP_REPO and not url(OLDREP_REPO):
        OLDREP_REPO = "https://github.com/shahmArabic/shahmAr"
    OLDREP_REPOBRANCH = os.environ.get("OLDREP_REPOBRANCH", "master")
    VC_REPO = os.environ.get("VC_REPO", "https://github.com/shahm-Arabic/RepVC")
