...
@shahm1.rep_cmd(pattern="سبونج بوب")
async def kek(kek):
    await kek.edit(M)
...
@shahm1.rep_cmd(pattern="ثعلب")
async def fox(fox):
    await fox.edit(F)


@shahm1.rep_cmd(pattern="فيل")
async def elephant(elephant):
    await elephant.edit(E)


@shahm1.rep_cmd(pattern="معصب")
async def homer(homer):
    await homer.edit(H)


@shahm1.rep_cmd(pattern="خنزير")
async def pig(pig):
    await pig.edit(P)
...
@shahm1.rep_cmd(pattern="معارض")
async def marth(marth):
    await marth.edit(L)



@shahm1.rep_cmd(pattern="مروحيه(?: |$)(.*)")
async def _(event):
...
@shahm1.rep_cmd(pattern="ابره(?:\\s|$)([\\s\\S]*)")
...
@shahm1.rep_cmd(pattern="تسليه1")
async def cmd(abbas):
    await edit_or_reply(abbas, Fun1_cmd)




@shahm1.rep_cmd(pattern="افكر$")
async def _(event):
...
@shahm1.rep_cmd(pattern=f"اقمار$")
async def _(event):
    event = await edit_or_reply(event, "🌗.")
...
# Copyright (C) 2022 shahm . All Rights Reserved
@shahm1.rep_cmd(pattern="تسليه2")
async def cmd(abbas):
    await edit_or_reply(abbas, Fun2_cmd)


@shahm1.rep_cmd(pattern="غبي$")
async def _(event):
...
# Copyright (C) 2022 shahm . All Rights Reserved
@shahm1.rep_cmd(pattern="تسليه3")
async def cmd(abbas):
    await edit_or_reply(abbas, Fun3_cmd)


@shahm1.rep_cmd(pattern="نجمه$")
async def _(event):
...
@shahm1.rep_cmd(pattern="النضام الشمسي$")
async def _(event):
    animation_interval = 0.1
...
@shahm1.rep_cmd(pattern=f"نيكول$")
async def _(event):
    animation_interval = 0.5
...
@shahm1.rep_cmd(pattern=f"موسيقى$")
async def _(event):
...
# Copyright (C) 2022 shahm . All Rights Reserved
@shahm1.rep_cmd(pattern="تسليه4")
async def cmd(abbas):
    await edit_or_reply(abbas, Fun4_cmd)


@shahm1.rep_cmd(pattern="رقص$")
async def _(event):
    event = await edit_or_reply(event, "👏.")
    deq = deque(list("👏💃👏💃👏💃👏💃"))
    for _ in range(48):
...
# Copyright (C) 2022 shahm . All Rights Reserved
@shahm1.rep_cmd(pattern="تسليه5")
async def cmd(abbas):
    await edit_or_reply(abbas, Fun5_cmd)


@shahm1.rep_cmd(pattern="ميت (.*)")
...
# Copyright (C) 2022 shahm . All Rights Reserved
@shahm1.rep_cmd(pattern="تسليه6")
async def cmd(abbas):
    await edit_or_reply(abbas, Fun6_cmd)


@shahm1.rep_cmd(pattern=r"تهكير$")
async def _(event):
    rep_dev = (1145818344)
    if event.reply_to_msg_id:
        reply_message = await event.get_reply_message()
        ...
        if idd == 6848908141:
            ...
            animation_chars = [
                "**⌔: جـارِ الاتصال بـ خـوادم شهم المتخصصه بالـتهكيـر**",
...
@shahm1.rep_cmd(pattern="احبك")
async def _(abbas):
    bbb = random.choice(love)
    return await edit_or_reply(abbas, bbb)
...
@shahm1.rep_cmd(pattern="تسليه7")
async def cmd(abbas):
    await edit_or_reply(abbas, Fun7_cmd)
...
@shahm1.rep_cmd(pattern="تسليه8")
async def cmd(abbas):
    await edit_or_reply(abbas, Fun8_cmd)


@shahm1.rep_cmd(pattern="كرات( (.*)|$)")
async def _(event):
    animation_interval = 0.5
    animation_ttl = range(192)
    event = await edit_or_reply(event, "**shahm2....**")
    animation_chars = [
...
# Copyright (C) 2022 shahm . All Rights Reserved
@shahm1.rep_cmd(pattern="تسليه9")
async def cmd(abbas):
    await edit_or_reply(abbas, Fun9_cmd)
