...
@shahm.rep_cmd(pattern="الطقس(?: |$)(.*)")
async def _(event):
    await edit_or_reply(event, "**- ارسـل .طقس + اسـم المدينـة**\n\n**- مثــال :**\n.طقس بغداد")


@shahm.rep_cmd(pattern="طقس (.*)")
async def _(event):
    if event.fwd_from:
        return
...
@shahm.rep_cmd(pattern="وهمي كتابه(?: |$)(.*)")
async def _(event):
...
@shahm.rep_cmd(pattern="وهمي صوت(?: |$)(.*)")
async def _(event):
    t = event.pattern_match.group(1)
    if not (t or t.isdigit()):
        t = 100
...
@shahm.rep_cmd(pattern="وهمي فيديو(?: |$)(.*)")
async def _(event):
    t = event.pattern_match.group(1)
    if not (t or t.isdigit()):
        t = 100
...
@shahm.rep_cmd(pattern="وهمي لعبه(?: |$)(.*)")
async def _(event):
    t = event.pattern_match.group(1)
    if not (t or t.isdigit()):
        t = 100
