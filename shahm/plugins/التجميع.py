...
@shahm1.rep_cmd(pattern="بوت المليار$")
async def _(event):
    await event.edit('@EEOBot')

# Copyright (C) 2022 shahm . All Rights Reserved
@shahm1.rep_cmd(pattern="المليار(?: |$)(.*)")
async def _(event):
    con = event.pattern_match.group(1).lower()
    await event.edit("**⎉╎حسنـاً .. تأكـد من انك مشتـرك بـ قنـوات الاشتـراك الاجبـاري لتجنب الأخطـاء @EEOBot**")
    channel_entity = await shahm1.get_entity('@EEOBot')
    await shahm1.send_message('@EEOBot', '/start')
    await asyncio.sleep(3)
    msg0 = await shahm1.get_messages('@EEOBot', limit=1)
    await msg0[0].click(2)
    await asyncio.sleep(3)
    msg1 = await shahm1.get_messages('@EEOBot', limit=1)
    await msg1[0].click(0)
    chs = 1
    for i in range(100):
        await asyncio.sleep(2)
        list = await shahm1(GetHistoryRequest(peer=channel_entity, limit=1, offset_date=None, offset_id=0, max_id=0, min_id=0, add_offset=0, hash=0))
        msgs = list.messages[0]
        if msgs.message.find('**⎉╎لا يوجد قنوات في الوقت الحالي .. قم يتجميع النقاط بطريقه مختلفه**') != -1:
            await shahm1.send_message(event.chat_id, "**⎉╎مـافي قنـوات بالبـوت حاليـاً ...**")
            break
        if con == "ايقاف": #Code by T.me/shahm41
            await shahm1.send_message(event.chat_id, "**⎉╎تم إيقـاف تجميـع النقـاط .. بنجـاح☑️**")
            break
        ...
        try:
            ...
            msg2 = await shahm1.get_messages('@EEOBot', limit=1)
    ...
    await shahm1.send_message(event.chat_id, "**⎉╎تم الانتهـاء مـن تجميـع النقـاط .. حاول من جديد في وقت آخر ✓**")


@shahm1.rep_cmd(pattern="بوت العرب$")
async def _(event):
    await event.edit('@xnsex21bot')

@shahm1.rep_cmd(pattern="العرب(?: |$)(.*)")
async def _(event):
    con = event.pattern_match.group(1).lower()
    await event.edit("**⎉╎حسنـاً .. تأكـد من انك مشتـرك بـ قنـوات الاشتـراك الاجبـاري لتجنب الأخطـاء @xnsex21bot**")
    channel_entity = await shahm1.get_entity('@xnsex21bot')
    await shahm1.send_message('@xnsex21bot', '/start')
    await asyncio.sleep(3)
    msg0 = await shahm1.get_messages('@xnsex21bot', limit=1)
    await msg0[0].click(2)
    await asyncio.sleep(3)
    msg1 = await shahm1.get_messages('@xnsex21bot', limit=1)
    await msg1[0].click(0)
    chs = 1
    for i in range(100):
        await asyncio.sleep(2)
        ...
        try:
            try:
                ...
                bott = url.split('/')[-1]
                await shahm1(ImportChatInviteRequest(bott))
            msg2 = await shahm1.get_messages('@xnsex21bot', limit=1)
            await msg2[0].click(text='تحقق')
            chs += 1
            await event.edit(f"**⎉╎تم الاشتـراك في القنـاة  {chs} ...✓**")
        except: #Code by T.me/shahm41
...
@shahm1.rep_cmd(pattern="بوت التجميع$")
async def _(event):
...
async def _(event):
    ...
    channel_entity = await shahm1.get_entity(rpoint)
    await shahm1.send_message(zpoint, '/start')
    await asyncio.sleep(3)
    msg0 = await shahm1.get_messages(zpoint, limit=1)
    await msg0[0].click(2)
    await asyncio.sleep(3)
    msg1 = await shahm1.get_messages(zpoint, limit=1)
    await msg1[0].click(0)
    chs = 1
    for i in range(100):
        await asyncio.sleep(2)
        ...
        try:
            try:
                ...
                bott = url.split('/')[-1]
                await shahm1(ImportChatInviteRequest(bott))
            msg2 = await shahm1.get_messages(rpoint, limit=1)
            await msg2[0].click(text='تحقق')
            chs += 1
            await event.edit(f"**⎉╎تم الاشتـراك في القنـاة  {chs} ...✓**")
        except: #Code by T.me/shahm41
...
@shahm1.rep_cmd(pattern="بوت الجوكر$")
async def _(event):
    await event.edit('@A_MAN9300BOT')

# Copyright (C) 2022 shahm . All Rights Reserved
@shahm1.rep_cmd(pattern="الجوكر(?: |$)(.*)")
async def _(event):
    con = event.pattern_match.group(1).lower()
    await event.edit("**⎉╎حسنـاً .. تأكـد من انك مشتـرك بـ قنـوات الاشتـراك الاجبـاري لتجنب الأخطـاء @A_MAN9300BOT**")
    channel_entity = await shahm1.get_entity('@A_MAN9300BOT')
    await shahm1.send_message('@A_MAN9300BOT', '/start')
    await asyncio.sleep(3)
    msg0 = await shahm1.get_messages('@A_MAN9300BOT', limit=1)
    await msg0[0].click(2)
    await asyncio.sleep(3)
    msg1 = await shahm1.get_messages('@A_MAN9300BOT', limit=1)
    await msg1[0].click(0)
    chs = 1
    for i in range(100):
        await asyncio.sleep(2)
        ...
        try:
            try:
                ...
                bott = url.split('/')[-1]
                await shahm1(ImportChatInviteRequest(bott))
            msg2 = await shahm1.get_messages('@A_MAN9300BOT', limit=1)
            await msg2[0].click(text='تحقق')
            chs += 1
            await event.edit(f"**⎉╎تم الاشتـراك في القنـاة  {chs} ...✓**")
        except: #Code by T.me/shahm41
...
@shahm1.rep_cmd(pattern="بوت الجنرال$")
async def _(event):
    await event.edit('@MARKTEBOT')

# Copyright (C) 2022 shahm . All Rights Reserved
@shahm1.rep_cmd(pattern="الجنرال(?: |$)(.*)")
async def _(event):
    con = event.pattern_match.group(1).lower()
    await event.edit("**⎉╎حسنـاً .. تأكـد من انك مشتـرك بـ قنـوات الاشتـراك الاجبـاري لتجنب الأخطـاء @MARKTEBOT**")
    channel_entity = await shahm1.get_entity('@MARKTEBOT')
    await shahm1.send_message('@MARKTEBOT', '/start')
    await asyncio.sleep(3)
    msg0 = await shahm1.get_messages('@MARKTEBOT', limit=1)
    await msg0[0].click(2)
    await asyncio.sleep(3)
    msg1 = await shahm1.get_messages('@MARKTEBOT', limit=1)
    await msg1[0].click(0)
    chs = 1
    for i in range(100):
        await asyncio.sleep(2)
        ...
        try:
            try:
                ...
                bott = url.split('/')[-1]
                await shahm1(ImportChatInviteRequest(bott))
            msg2 = await shahm1.get_messages('@MARKTEBOT', limit=1)
            await msg2[0].click(text='تحقق')
            chs += 1
            await event.edit(f"**⎉╎تم الاشتـراك في القنـاة  {chs} ...✓**")
        except: #Code by T.me/shahm41
...
@shahm1.rep_cmd(pattern="بوت المليون$")
async def _(event):
    await event.edit('@qweqwe1919bot')

# Copyright (C) 2022 shahm . All Rights Reserved
@shahm1.rep_cmd(pattern="المليون(?: |$)(.*)")
async def _(event):
    con = event.pattern_match.group(1).lower()
    await event.edit("**⎉╎حسنـاً .. تأكـد من انك مشتـرك بـ قنـوات الاشتـراك الاجبـاري لتجنب الأخطـاء @qweqwe1919bot**")
    channel_entity = await shahm1.get_entity('@qweqwe1919bot')
    await shahm1.send_message('@qweqwe1919bot', '/start')
    await asyncio.sleep(3)
    msg0 = await shahm1.get_messages('@qweqwe1919bot', limit=1)
    await msg0[0].click(2)
    await asyncio.sleep(3)
    msg1 = await shahm1.get_messages('@qweqwe1919bot', limit=1)
    await msg1[0].click(0)
    chs = 1
    for i in range(100):
        await asyncio.sleep(2)
        ...
        try:
            try:
                ...
                bott = url.split('/')[-1]
                await shahm1(ImportChatInviteRequest(bott))
            msg2 = await shahm1.get_messages('@qweqwe1919bot', limit=1)
            await msg2[0].click(text='تحقق')
            chs += 1
            await event.edit(f"**⎉╎تم الاشتـراك في القنـاة  {chs} ...✓**")
        except: #Code by T.me/shahm41
...
@shahm1.rep_cmd(pattern="بوت سمسم$")
async def _(event):
    await event.edit('@SMSMWAbot')

# Copyright (C) 2023 shahm . All Rights Reserved
@shahm1.rep_cmd(pattern="سمسم(?: |$)(.*)")
async def _(event):
    con = event.pattern_match.group(1).lower()
    await event.edit("**⎉╎حسنـاً .. تأكـد من انك مشتـرك بـ قنـوات الاشتـراك الاجبـاري لتجنب الأخطـاء @SMSMWAbot**")
    channel_entity = await shahm1.get_entity('@SMSMWAbot')
    await shahm1.send_message('@SMSMWAbot', '/start')
    await asyncio.sleep(3)
    msgz = await shahm1.get_messages('@SMSMWAbot', limit=1)
    await msgz[0].click(0)
    await asyncio.sleep(3)
    msg0 = await shahm1.get_messages('@SMSMWAbot', limit=1)
    await msg0[0].click(3)
    await asyncio.sleep(3)
    msg1 = await shahm1.get_messages('@SMSMWAbot', limit=1)
    ...
    for i in range(100):
        ...
        try:
            try:
                ...
                bott = url.split('/')[-1]
                await shahm1(ImportChatInviteRequest(bott))
            msg2 = await shahm1.get_messages('@SMSMWAbot', limit=1)
            await msg2[0].click(text='تحقق')
            chs += 1
            await event.edit(f"**⎉╎تم الاشتـراك في القنـاة  {chs} ...✓**")
        except: #Code by T.me/shahm41
...
@shahm1.rep_cmd(pattern="بوت تناهيد$")
async def _(event):
    await event.edit('@Ncoe_bot')

# Copyright (C) 2023 shahm . All Rights Reserved
@shahm1.rep_cmd(pattern="تناهيد(?: |$)(.*)")
async def _(event):
    con = event.pattern_match.group(1).lower()
    await event.edit("**⎉╎حسنـاً .. تأكـد من انك مشتـرك بـ قنـوات الاشتـراك الاجبـاري لتجنب الأخطـاء @Ncoe_bot**")
    channel_entity = await shahm1.get_entity('@Ncoe_bot')
    await shahm1.send_message('@Ncoe_bot', '/start')
    await asyncio.sleep(3)
    msg0 = await shahm1.get_messages('@Ncoe_bot', limit=1)
    await msg0[0].click(2)
    await asyncio.sleep(3)
    msg1 = await shahm1.get_messages('@Ncoe_bot', limit=1)
    await msg1[0].click(0)
    chs = 1
    for i in range(100):
        await asyncio.sleep(2)
        ...
        try:
            try:
                ...
                bott = url.split('/')[-1]
                await shahm1(ImportChatInviteRequest(bott))
            msg2 = await shahm1.get_messages('@Ncoe_bot', limit=1)
            await msg2[0].click(text='تحقق')
            chs += 1
            await event.edit(f"**⎉╎تم الاشتـراك في القنـاة  {chs} ...✓**")
        except: #Code by T.me/shahm41
...
async def _(event):
    ...
    for i in range(100):
        ...
        if "اشترك فالقناة @" in msg_text:
            ...
            try:
                entity = await shahm1.get_entity(the_channel)
                if entity:
                    await shahm1(JoinChannelRequest(entity.id))
                    await asyncio.sleep(4)
                    msg2 = await shahm1.get_messages(bot_username6, limit=1)
                    await msg2[0].click(text='اشتركت ✅')
                    chs += 1
                    await event.edit(f"**⎉╎تم الاشتـراك في القنـاة  {chs} ...✓**")
            except:
                await shahm1.send_message(event.chat_id, f"**⎉╎خطـأ , يمكـن تبنـدت ؟!**")
                break
    await shahm1.send_message(event.chat_id, "**⎉╎تم الانتهـاء مـن تجميـع النقـاط .. حاول من جديد في وقت آخر ✓**")


@shahm1.rep_cmd(pattern="بوت المهدوي$")
async def _(event):
    await event.edit('@MHDN313bot')

# Copyright (C) 2022 shahm . All Rights Reserved
@shahm1.rep_cmd(pattern="المهدوي(?: |$)(.*)")
async def _(event):
    con = event.pattern_match.group(1).lower()
    await event.edit("**⎉╎حسنـاً .. تأكـد من انك مشتـرك بـ قنـوات الاشتـراك الاجبـاري لتجنب الأخطـاء @EEOBot**")
    channel_entity = await shahm1.get_entity('@MHDN313bot')
    await shahm1.send_message('@MHDN313bot', '/start')
    await asyncio.sleep(3)
    msg0 = await shahm1.get_messages('@MHDN313bot', limit=1)
    await msg0[0].click(2)
    await asyncio.sleep(3)
    msg1 = await shahm1.get_messages('@MHDN313bot', limit=1)
    await msg1[0].click(0)
    chs = 1
    for i in range(100):
        await asyncio.sleep(2)
        ...
        try:
            try:
                ...
                bott = url.split('/')[-1]
                await shahm1(ImportChatInviteRequest(bott))
            msg2 = await shahm1.get_messages('@MHDN313bot', limit=1)
            await msg2[0].click(text='تحقق')
            chs += 1
            await event.edit(f"**⎉╎تم الاشتـراك في القنـاة  {chs} ...✓**")
        except: #Code by T.me/shahm41
...
# Code by @r0r77 & @Dar4k
@shahm1.rep_cmd(pattern="بخشيش وعد(?:\s|$)([\s\S]*)")
...
async def the_bahsees(event):
    ...
    if bahsees:
        await the_bahsees(event)  
@shahm1.rep_cmd(pattern="ايقاف بخشيش وعد(?:\s|$)([\s\S]*)")
async def baqshis(event):
    global bahsees
    bahsees = False
    await event.edit("**⎉╎تم إيقـاف تجميـع البخشيش  .. بنجـاح ✓** ")

@shahm1.rep_cmd(pattern="سرقة وعد(?:\s|$)([\s\S]*)")
...
@shahm1.rep_cmd(pattern="ايقاف سرقة وعد(?:\s|$)([\s\S]*)")
...
@shahm1.rep_cmd(pattern="راتب وعد(?:\s|$)([\s\S]*)")
async def thift(event):
    global ratp
    await event.delete()
    if not ratp:
...
async def the_ratp(event):
    ...
    if ratp:
        await the_ratp(event)  
@shahm1.rep_cmd(pattern="ايقاف راتب وعد(?:\s|$)([\s\S]*)")
async def thift(event):
    global ratp
    ratp = False
...
@shahm1.rep_cmd(pattern="كلمات وعد (.*)")
async def waorwaad(event):
    for i in range(int("".join(event.text.split(maxsplit=2)[2:]).split(" ", 2)[0])):
        chat = event.chat_id
        await shahm1.send_message(chat, "كلمات")
        await asyncio.sleep(0.5)
        masg = await shahm1.get_messages(chat, limit=1)
        masg = masg[0].message
        masg = ("".join(masg.split(maxsplit=3)[3:])).split(" ", 2)
        if len(masg) == 2:
            msg = masg[0]
            await shahm1.send_message(chat, msg)
        else:
            msg = masg[0] + " " + masg[1]
            await shahm1.send_message(chat, msg)


@shahm1.rep_cmd(pattern="استثمار وعد")
async def _(event):
    await event.delete()
    global estithmar
    estithmar = True
    while estithmar:
        if event.is_group:
            ...
            shahm1 = reepthon[0]
            if shahm1.isdigit() and int(shahm1) > 500000000:
                await event.client.send_message(event.chat_id,f"استثمار {shahm1}")
...
@shahm1.rep_cmd(pattern="ايقاف استثمار وعد")
...
@shahm1.rep_cmd(pattern="اوامر النقاط")
async def cmd(abbas):
    await edit_or_reply(abbas, abbasCoins_cmd)

@shahm1.rep_cmd(pattern="اوامر التجميع")
async def cmd(abbas):
    await edit_or_reply(abbas, abbasCoins_cmd)
