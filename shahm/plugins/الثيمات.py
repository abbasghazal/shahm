...
@shahm.rep_cmd(pattern="ثيمات")
async def zed(shahm):
    await edit_or_reply(shahm, ZL)

@shahm.rep_cmd(pattern="الثيمات")
async def zed(shahm):
