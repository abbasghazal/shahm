...
async def writer(e):
    ...
    img = Image.open("abbas/taiba/ppmsg.jpg")
    draw = ImageDraw.Draw(img)
    font = ImageFont.truetype("abbas/taiba/zarz.ttf", 30)
    x, y = 150, 140
    lines = text_set(text)
