...
@shahm1.rep_cmd(pattern=r"اضف فار (.*)")
...
# Copyright (C) 2022 shahmArabic . All Rights Reserved
@shahm1.rep_cmd(pattern="حذف فار(?:\\s|$)([\\s\\S]*)")
async def variable(event):
...
# Copyright (C) 2022 shahmArabic . All Rights Reserved
@shahm1.rep_cmd(pattern="جلب فار(?:\\s|$)([\\s\\S]*)")
...
# Copyright (C) 2022 shahmArabic . All Rights Reserved
@shahm1.rep_cmd(pattern="وقت(?:\\s|$)([\\s\\S]*)")
async def variable(event):
...
@shahm1.rep_cmd(pattern="اضف صورة (الحماية|الحمايه|الفحص|الوقتي|البوت|الكتم) ?(.*)")
async def _(tiba):
    if tiba.fwd_from:
        return
...
# Copyright (C) 2022 shahm . All Rights Reserved
@shahm1.rep_cmd(pattern="اوامر الفارات")
async def cmd(abbas):
    await edit_or_reply(abbas, abbasVP_cmd)

@shahm1.rep_cmd(pattern="الفارات")
async def cmd(abbas):
    await edit_or_reply(abbas, abbasVP_cmd)

@shahm1.rep_cmd(pattern="اوامر الوقت")
async def cmd(abbas):
    await edit_or_reply(abbas, abbasTZ_cmd)

@shahm1.rep_cmd(pattern="الوقت")
async def cmd(abbas):
    await edit_or_reply(abbas, abbasTZ_cmd)
