...
@shahm1.rep_cmd(pattern="رابط الحذف")
async def _(zed):
    await edit_or_reply (zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝑺𝑯𝑨𝑯𝑴 - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/shahm50) 🗑♻️𓆪\n**𓍹━─━─━─━─𝐑𝐞𝐩𝐭𝐡𝐨𝐧─━─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")

########################  SOURCE ZED ~ BY: shahm (@shahm41)  ########################

@shahm1.rep_cmd(pattern="رفع جلب(?: |$)(.*)")
...
@shahm1.rep_cmd(pattern="رفع مرتي(?: |$)(.*)")
async def permalink(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@shahm1.rep_cmd(pattern="رفع تاج(?: |$)(.*)")
async def permalink(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@shahm1.rep_cmd(pattern="رفع بكلبي(?: |$)(.*)")
async def permalink(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@shahm1.rep_cmd(pattern="رفع بقلبي(?: |$)(.*)")
async def permalink(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@shahm1.rep_cmd(pattern="رفع قلبي(?: |$)(.*)")
async def permalink(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@shahm1.rep_cmd(pattern="رفع جريذي(?: |$)(.*)")
async def permalink(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@shahm1.rep_cmd(pattern="رفع فرخ(?: |$)(.*)")
async def permalink(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
abbasTHS_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝑺𝑯𝑨𝑯𝑴 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر التحشيش](t.me/shahm50) 𓆪\n\n"
...
@shahm1.rep_cmd(pattern="كت(?: |$)(.*)")
async def mention(mention):
    medo = random.choice(kettuet)
    await edit_or_reply(mention, f"**⌔╎{medo}**")

@shahm1.rep_cmd(pattern="(نسبه الحب|نسبة الحب)(?: |$)(.*)")
async def zed(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
    shah = user.first_name.replace("\u2060", "") if user.first_name else user.username
    sha = random.choice(mth)
    await edit_or_reply(mention, f"**✾╎نـسبـة حبكـم انـت و**  [{shah}](tg://user?id={user.id}) **هـي {sha} 😻♥️**")
@shahm1.rep_cmd(pattern="(نسبه الانوثة|نسبة الانوثه|نسبه الانوثه|نسبة الانوثة)(?: |$)(.*)")
async def zed(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
    ...
    if user.id == 6848908141 or user.id == 6848908141 or user.id == 6848908141:
        return await edit_or_reply(mention, f"**╮ ❐ لك دي . . هـذا مطـور السـورس  ❏╰**")
    shah = user.first_name.replace("\u2060", "") if user.first_name else user.username
    sha = random.choice(zid)
    await edit_or_reply(mention, f"**✾╎نسبـة الانوثه لـ**  [{shah}](tg://user?id={user.id}) **هـي {sha} 🤰**")
@shahm1.rep_cmd(pattern="(نسبه الغباء|نسبة الغباء)(?: |$)(.*)")
async def permalink(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
    if user.id == 6848908141:
        return await edit_or_reply(mention, f"**╮ ❐ لك دي . . هـذا احـد مطـورين السـورس  ❏╰**")
    if user.id == 6848908141 or user.id == 6848908141 or user.id == 6848908141:
        return await edit_or_reply(mention, f"**╮ ❐ لك دي . . هـذا مطـور السـورس  ❏╰**")
    shah = user.first_name.replace("\u2060", "") if user.first_name else user.username
    sha = random.choice(zid)
    await edit_or_reply(mention, f"**✾╎نسبـة الغبـاء لـ**  [{shah}](tg://user?id={user.id}) **هـي {sha} 😂💔**")
@shahm1.rep_cmd(pattern="(نسبه الانحراف|نسبة الانحراف)(?: |$)(.*)")
async def permalink(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
    ...
    shah = user.first_name.replace("\u2060", "") if user.first_name else user.username
    sha = random.choice(zid)
    await edit_or_reply(mention, f"**✾╎نسبـة الانحـراف لـ**  [{shah}](tg://user?id={user.id}) **هـي {sha} 🥵🖤**")
@shahm1.rep_cmd(pattern="(نسبه المثليه|نسبة المثليه)(?: |$)(.*)")
async def permalink(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
    ...
    shah = user.first_name.replace("\u2060", "") if user.first_name else user.username
    sha = random.choice(zid)
    await edit_or_reply(mention, f"**✾╎نسبـة المثليـه لـ**  [{shah}](tg://user?id={user.id}) **هـي {sha} 🤡 🏳️‍🌈.**")
@shahm1.rep_cmd(pattern="(نسبه النجاح|نسبة النجاح)(?: |$)(.*)")
async def permalink(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
    shah = user.first_name.replace("\u2060", "") if user.first_name else user.username
    sha = random.choice(zid)
    await edit_or_reply(mention, f"**✾╎نسبـة النجـاح لـ** [{shah}](tg://user?id={user.id}) **هـي {sha} 🤓.**") 
@shahm1.rep_cmd(pattern="(نسبه الكراهية|نسبة الكراهيه|نسبه الكراهيه|نسبة الكراهية)(?: |$)(.*)")
async def permalink(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
    shah = user.first_name.replace("\u2060", "") if user.first_name else user.username
    sha = random.choice(zid)
    await edit_or_reply(mention, f"**✾╎نسبـة الكراهيـة لـ** [{shah}](tg://user?id={user.id}) **هـي {sha} 🤮.**")
@shahm1.rep_cmd(pattern="رفع ورع(?: |$)(.*)")
async def zed(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
    ...
    if user.id == 6848908141 or user.id == 6848908141 or user.id == 6848908141:
        return await edit_or_reply(mention, f"**╮ ❐ لك دي . . هـذا مطـور السـورس  ❏╰**")
    shah2 = user.first_name.replace("\u2060", "") if user.first_name else user.username
    me = await mention.client.get_me()
    my_first = me.first_name
    my_mention = f"[{me.first_name}](tg://user?id={me.id})"
    await edit_or_reply(mention, f"**🚹 ╎ المستخـدم  ⪼ • ** [{shah2}](tg://user?id={user.id}) \n☑️ **╎ تم رفعـه ورع القـروب .. بنجـاح😹🙇🏻.** \n**🤵‍♂️ ╎ بواسطـه  :** {my_mention} ")
@shahm1.rep_cmd(pattern="رفع مزه(?: |$)(.*)")
async def zed(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
    ...
    my_first = me.first_name
    my_mention = f"[{me.first_name}](tg://user?id={me.id})"
    await edit_or_reply(mention, f"**🚺 ╎ المستخـدم ه ⪼ • ** [{shah2}](tg://user?id={user.id}) \n☑️ **╎ تم رفعـها مـزة الكروب .. بنجـاح 🥳💃.** \n**🤵‍♂️ ╎ بواسطـه  :** {my_mention} ")
@shahm1.rep_cmd(pattern="رفع مطي(?: |$)(.*)")
async def zed(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@shahm1.rep_cmd(pattern="رفع حمار(?: |$)(.*)")
async def zed(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
    ...
    my_mention = f"[{me.first_name}](tg://user?id={me.id})"
    await edit_or_reply(mention, f"**🚹 ╎ المستخـدم  ⪼ • ** [{shah2}](tg://user?id={user.id}) \n☑️ **╎ تم رفعـه حمار جحا 😂🐴.** \n**🤵‍♂️ ╎ بواسطـه  :** {my_mention} ")
@shahm1.rep_cmd(pattern="رفع خروف(?: |$)(.*)")
async def zed(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
    ...
    my_mention = f"[{me.first_name}](tg://user?id={me.id})"
    await edit_or_reply(mention, f"**🚹 ╎ المستخـدم  ⪼ • ** [{shah2}](tg://user?id={user.id}) \n☑️ **╎ تم رفعـه خـروف 🐑.** \n**🤵‍♂️ ╎ بواسطـه  :** {my_mention} ")
@shahm1.rep_cmd(pattern="رفع حيوان(?: |$)(.*)")
async def permalink(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
    ...
    my_mention = f"[{me.first_name}](tg://user?id={me.id})"
    await edit_or_reply(mention, f"**🚹 ╎ المستخـدم  ⪼ • ** [{shah2}](tg://user?id={user.id}) \n☑️ **🐑╎ تم رفعـه حيـوان .** \n**🤵‍♂️ ╎ بواسطـه  :** {my_mention} ")
@shahm1.rep_cmd(pattern="رفع بزون(?: |$)(.*)")
async def permalink(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
    ...
    my_mention = f"[{me.first_name}](tg://user?id={me.id})"
    await edit_or_reply(
        mention, f"**🚹 ╎ المستخـدم  ⪼ • ** [{shah2}](tg://user?id={user.id}) \n☑️ **🐈╎ تم رفعـه بـزون .** \n**🤵‍♂️ ╎ بواسطـه  :** {my_mention} "
    )
@shahm1.rep_cmd(pattern="رفع زباله(?: |$)(.*)")
async def zed(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@shahm1.rep_cmd(pattern="رفع منشئ(?: |$)(.*)")
async def zed(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@shahm1.rep_cmd(pattern="رفع مدير(?: |$)(.*)")
async def zed(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@shahm1.rep_cmd(pattern="رفع كواد(?: |$)(.*)")
async def zed(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@shahm1.rep_cmd(pattern="رفع مرتبط(?: |$)(.*)")
async def zed(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@shahm1.rep_cmd(pattern="رفع مرتبطه(?: |$)(.*)")
async def zed(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@shahm1.rep_cmd(pattern="رفع حبيبي(?: |$)(.*)")
async def zed(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@shahm1.rep_cmd(pattern="رفع خطيبتي(?: |$)(.*)")
async def zed(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@shahm1.rep_cmd(pattern="رفع صاك(?: |$)(.*)")
async def zed(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
    ...
    my_mention = f"[{me.first_name}](tg://user?id={me.id})"
    await edit_or_reply(mention, f"**🚹 ╎ المستخـدم  ⪼ • ** [{shah2}](tg://user?id={user.id}) \n☑️ **╎  تم رفعـه صاك 🤴 .** \n**🤵‍♂️ ╎ بواسطـه  : ** {my_mention} ")
@shahm1.rep_cmd(pattern="رفع صاكه(?: |$)(.*)")
async def zed(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
    ...
    my_mention = f"[{me.first_name}](tg://user?id={me.id})"
    await edit_or_reply(mention, f"**🚹 ╎ المستخـدم  ⪼ • ** [{shah2}](tg://user?id={user.id}) \n☑️ **╎  تم رفعـها صاكه 👸🏼.** \n**🤵‍♂️ ╎ بواسطـه  : ** {my_mention} ")
@shahm1.rep_cmd(pattern="رفع حات(?: |$)(.*)")
async def zed(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@shahm1.rep_cmd(pattern="رفع حاته(?: |$)(.*)")
async def zed(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@shahm1.rep_cmd(pattern="التحشيش")
async def cmd(abbas):
    await edit_or_reply(abbas, abbasTHS_cmd)
