#𝑺𝑯𝑨𝑯𝑴 ®
#الملـف حقـوق وكتابـة روجر ⤶ @shahm41 خاص بسـورس ⤶ 𝑺𝑯𝑨𝑯𝑴
...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝑺𝑯𝑨𝑯𝑴 𓆪 </b> - @shahm50 "
...
async def who(event):
    ...
    if replied_user.id == 6848908141 or replied_user.id == 6848908141 or replied_user.id == 6848908141:
