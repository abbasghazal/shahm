...
from . import BOTLOG, BOTLOG_CHATID, shahm
...
@shahm.rep_cmd(pattern="انستا(?: |$)([\s\S]*)")
async def shahm_gif(event):
    ...
    async with borg.conversation(chat) as conv: #Code by T.me/shahm41
        try:
            ...
            await shahm(unblock("FullSavebot"))
            await conv.send_message("/start")
            await conv.get_response()
...
#Code by T.me/shahm41
@shahm.rep_cmd(pattern="لايكي(?: |$)([\s\S]*)")
async def shahm_lik(event):
    ...
    async with borg.conversation(chat) as conv: #Code by T.me/shahm41
        try:
            ...
            await shahm(unblock("savetok_bot"))
            await conv.send_message("/start")
            await conv.get_response()
            await conv.send_message(link)
            await conv.get_response()
...
#Code by T.me/shahm41
@shahm.rep_cmd(pattern="بنترست(?: |$)([\s\S]*)")
async def shahm_pin(event):
    ...
    async with borg.conversation(chat) as conv: #Code by T.me/shahm41
        try:
            ...
            await shahm(unblock("GoPinterestBot"))
            await conv.send_message("/start")
            await conv.get_response()
            await conv.send_message(link)
            await conv.get_response()
