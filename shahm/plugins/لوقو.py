...
""" 
Logo & Style for shahm™ t.me/shahm50
Write file by abbas t.me/shahm41
...
async def lg1(userevent):
    ...
    if gvarstatus("REP_FONTS") is None: # code by t.me/shahm41
    ...
    if arabic_text: # code by t.me/shahm41
...
async def lg1(userevent):
    ...
    if not arabic_text: # code by t.me/shahm41
