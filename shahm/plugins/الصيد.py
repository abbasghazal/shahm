...
@shahm1.rep_cmd(pattern="الصيد")
async def cmd(abbas):
    await edit_or_reply(abbas, abbasChecler_cmd)


@shahm1.rep_cmd(pattern="صيد (.*)")
...
@shahm1.rep_cmd(pattern="حالة الصيد")
async def _(event):
    if "on" in isclaim:
...
@shahm1.rep_cmd(pattern="حالة التثبيت")
async def _(event):
    if "on" in isauto:
...
@shahm1.rep_cmd(pattern="حاله الصيد")
async def _(event):
    if "on" in isclaim:
        await event.edit(f"**- الصيد وصل لـ({trys[0]}) من المحـاولات**")
    elif "off" in isclaim:
...
@shahm1.rep_cmd(pattern="حاله التثبيت")
async def _(event):
    if "on" in isauto:
        await event.edit(f"**- التثبيت وصل لـ({trys2[0]}) من المحاولات**")
    elif "off" in isauto:
...
@shahm1.rep_cmd(pattern="ايقاف الصيد")
async def _(event):
    if "on" in isclaim:
        isclaim.clear()
        isclaim.append("off")
...
@shahm1.rep_cmd(pattern="ايقاف التثبيت")
async def _(event):
    if "on" in isauto:
        isauto.clear()
        isauto.append("off")
