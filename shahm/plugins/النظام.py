...
from . import shahm, BOTLOG, BOTLOG_CHATID, HEROKU_APP, mention, StartTime, repversion
...
@shahm.rep_cmd(pattern="الانترنت(?:\\s|$)([\\s\\S]*)")
async def _(event):
...
@shahm.rep_cmd(pattern="تاريخ التنصيب$")
