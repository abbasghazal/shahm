...
async def source(e):
    "Source code link of shahm"
    await edit_or_reply(
        e,
        "Click [here](https://t.me/Shahm50) to open this bot source code\
        \nClick [here](https://t.me/Shahm50/117) to open supported link for heroku",
    )
