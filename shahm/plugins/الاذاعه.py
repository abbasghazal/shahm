...
@shahm1.rep_cmd(pattern="الاذاعه")
async def cmd(abbas):
    await edit_or_reply(abbas, abbas_cmd)


@shahm1.rep_cmd(pattern=f"للمجموعات(?: |$)(.*)")
...
@shahm1.rep_cmd(pattern=f"للخاص(?: |$)(.*)")
...
async def pmto(event):
    ...
    if msg == "":
        return
    try:
        await shahm1.send_message(chat_id, msg)
