...
@shahm.rep_cmd(pattern="ملصق متحرك(?: |$)(.*)")
...
@shahm.rep_cmd(pattern="لمتحركه(?: |$)((-)?(r|l|u|d|s|i)?)$")
...
@shahm.rep_cmd(pattern="متحرك ?([0-9.]+)?$")
async def _(event):
    reply = await event.get_reply_message()
