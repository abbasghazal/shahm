...
if gvarstatus("ALIVE_NAME") is None: #Code by T.me/shahm41
    try:
        ...
        shahm1.loop.run_until_complete(autoname())
...
try:
    ...
    shahm1.loop.run_until_complete(setup_bot())
...
try:
    ...
    shahm1.loop.run_until_complete(mybot())
...
shahm1.loop.run_until_complete(startup_process())
