        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @shahm41\
                                  \n\n--------بـدء تتبـع سجـل شـهــم 𝑺𝑯𝑨𝑯𝑴--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع شـهــم 𝑺𝑯𝑨𝑯𝑴--------"
                        ...
                        link = "[𐇮 ℡𓆩✗ ¦ ↱𝐺𝑜𝑙 𝐷. 𝑅𝑜𝑔𝑒𝑟↲ ¦ ✗𖠚卐𓆪 𐇮](https://t.me/shahm41)"
                        text = (
                            "**✘ تقـريـر اشعـار شـهــم 𝑺𝑯𝑨𝑯𝑴 ✘**\n\n"
            ...
            if pattern is not None:
                ...
                if edited:
                    shahm1.add_event_handler(func, events.MessageEdited(**kwargs))
                shahm1.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار شـهــم 𝑺𝑯𝑨𝑯𝑴 ✘**\n\n "
                        link = "[𐇮 ℡𓆩✗ ¦ ↱𝐺𝑜𝑙 𝐷. 𝑅𝑜𝑔𝑒𝑟↲ ¦ ✗𖠚卐𓆪 𐇮](https://t.me/shahm41)"
            ...
            if edited is True:
                shahm1.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                shahm1.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
