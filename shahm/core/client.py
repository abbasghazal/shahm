        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            ...
            if pattern is not None:
                ...
                if edited:
                    shahm.add_event_handler(func, events.MessageEdited(**kwargs))
                shahm.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                shahm.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                shahm.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
